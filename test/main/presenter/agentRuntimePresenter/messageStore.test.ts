...
describe("DeepChatMessageStore", () => {
  ...
  describe("createUserMessage", () => {
    it("inserts a user message with JSON content", () => {
      ...
      expect(sqlitePresenter.deepchatUserMessageFilesTable.replaceForMessage).toHaveBeenCalledWith("mock-msg-id", []);
      expect(sqlitePresenter.deepchatUserMessageLinksTable.replaceForMessage).toHaveBeenCalledWith("mock-msg-id", []);
    });
  });
  ...
  describe("updateAssistantContent", () => {
    it("updates structured assistant blocks and keeps the header pending", () => {
      ...
      expect(sqlitePresenter.deepchatAssistantBlocksTable.replaceForMessage).toHaveBeenCalledWith("m1", blocks);
  ...
  describe("deleteBySession", () => {
    it("delegates to table", () => {
      ...
      expect(sqlitePresenter.deepchatSearchDocumentsTable.deleteBySession).toHaveBeenCalledWith("s1");
      expect(sqlitePresenter.deepchatAssistantBlocksTable.deleteBySession).toHaveBeenCalledWith("s1");
      expect(sqlitePresenter.deepchatUserMessageLinksTable.deleteBySession).toHaveBeenCalledWith("s1");
      expect(sqlitePresenter.deepchatUserMessageFilesTable.deleteBySession).toHaveBeenCalledWith("s1");
      expect(sqlitePresenter.deepchatUserMessagesTable.deleteBySession).toHaveBeenCalledWith("s1");
      expect(sqlitePresenter.deepchatMessageTracesTable.deleteBySessionId).toHaveBeenCalledWith("s1");
      expect(sqlitePresenter.deepchatMessageSearchResultsTable.deleteBySessionId).toHaveBeenCalledWith("s1");
  ...
  describe("deleteMessage", () => {
    it("deletes traces and search results before removing the message", () => {
      ...
      expect(sqlitePresenter.deepchatMessageTracesTable.deleteByMessageIds).toHaveBeenCalledWith(["m1"]);
      expect(sqlitePresenter.deepchatMessageSearchResultsTable.deleteByMessageIds).toHaveBeenCalledWith(["m1"]);
  ...
  describe("deleteFromOrderSeq", () => {
    it("deletes traces for affected messages before deleting messages", () => {
      ...
      expect(sqlitePresenter.deepchatSearchDocumentsTable.deleteByMessageIds).toHaveBeenCalledWith(["m2", "m3"]);
      expect(sqlitePresenter.deepchatAssistantBlocksTable.deleteByMessageIds).toHaveBeenCalledWith(["m2", "m3"]);
      expect(sqlitePresenter.deepchatUserMessageLinksTable.deleteByMessageIds).toHaveBeenCalledWith(["m2", "m3"]);
      expect(sqlitePresenter.deepchatUserMessageFilesTable.deleteByMessageIds).toHaveBeenCalledWith(["m2", "m3"]);
      expect(sqlitePresenter.deepchatUserMessagesTable.deleteByMessageIds).toHaveBeenCalledWith(["m2", "m3"]);
      expect(sqlitePresenter.deepchatMessageTracesTable.deleteByMessageIds).toHaveBeenCalledWith(["m2", "m3"]);
    ...
    it("skips trace deletion when no affected messages", () => {
      ...
      expect(sqlitePresenter.deepchatUserMessageLinksTable.deleteByMessageIds).not.toHaveBeenCalled();
      expect(sqlitePresenter.deepchatUserMessageFilesTable.deleteByMessageIds).not.toHaveBeenCalled();
