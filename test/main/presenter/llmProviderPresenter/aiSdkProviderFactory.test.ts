...
describe("AI SDK provider factory", () => {
  ...
  it("preserves deployment-based azure urls and legacy api versions", () => {
    expect(
      normalizeAzureBaseUrl("https://example.openai.azure.com/openai/deployments/deepchat-prod", undefined),
    ).toEqual({
      baseURL: "https://example.openai.azure.com/openai",
    ...
    expect(
      normalizeAzureBaseUrl("https://example.openai.azure.com/openai/deployments/deepchat-prod", "2025-04-01-preview"),
    ).toEqual({
      baseURL: "https://example.openai.azure.com/openai",
