...
const setup = async (options: SetupOptions = {}) => {
  ...
  const remoteControlPresenter = {
    ...
    removeChannelPrincipal: vi.fn(async (_channel: string, principalId: string) => {
      remoteState.pairingSnapshot.allowedUserIds =
        remoteState.pairingSnapshot.allowedUserIds.filter((value) => String(value) !== principalId)
    })
  }
  ...
  const RemoteSettings = (await import('../../../src/renderer/settings/components/RemoteSettings'))
    .default
