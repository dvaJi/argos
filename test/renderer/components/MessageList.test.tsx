...
vi.mock('@/components/message/MessageBlockAction', () => ({
  default: ({ block }: any) => (
    <div className="rate-limit-block-stub">{block.action_type || 'unknown'}</div>
  )
}))
...
describe('MessageList', () => {
  ...
  it('switches inline compaction copy between compacting and compacted', () => {
    ...
    const compactingIndicator = compactingContainer.querySelector(
    ...
    const compactedIndicator = compactedContainer.querySelector(
      '[data-compaction-indicator="true"]'
    )
