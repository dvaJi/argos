...
public final class PermissionsGate {
    ...
    /// Argos Computer Use.app, where "nothing happens" is the wrong UX even
    ...
    private func presentWindow(initialStatus: PermissionsStatus) {
        ...
        window.title = "Argos Computer Use Permissions"
...
private struct PermissionsRootView: View {
    ...
    private var subheading: String {
        ...
        return "Grant both so Argos Computer Use can inspect and drive native "
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 16) {
            ...
            PermissionRowSwiftUI(
                title: "Accessibility",
                subtitle:
                    "Lets Argos Computer Use read the accessibility tree of running apps "
            ...
            PermissionRowSwiftUI(
                ...
                subtitle:
                    "Lets Argos Computer Use capture per-window screenshots so agents can "
            ...
            if allGranted {
                ...
                HStack(spacing: 8) {
                    ...
                    Text("All set. Argos Computer Use is ready to use.")
                        .font(.system(size: 12))
                }
