...
export class FileValidationService implements IFileValidationService {
  private excludedAdapters = ["AudioFileAdapter", "ImageFileAdapter", "UnsupportFileAdapter", "DirectoryAdapter"];
  ...
  getSupportedExtensions(): string[] {
    try {
      ...
      commonExtensions.forEach((extension) => supportedExtensions.add(extension));
