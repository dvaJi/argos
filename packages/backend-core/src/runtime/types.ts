...
export interface ProcessHooks {
  ...
  autoGrantPermission?: (permission: NonNullable<PendingToolInteraction["permission"]>) => Promise<void>;
...
export function createState(): RuntimeStreamState {
  return {
    blocks: [],
    metadata: {},
    startTime: Date.now(),
