...
export interface ModelBatchStatusChangedEvent {
  providerId: string;
  updates: { modelId: string; enabled: boolean }[];
}

export interface ModelStatusHelperOptions {
  store: StoreLike<any>;
  setSetting: SetSetting;
  onModelStatusChanged?: (event: ModelStatusChangedEvent) => void;
  onModelBatchStatusChanged?: (event: ModelBatchStatusChangedEvent) => void;
}

export class ModelStatusHelper {
  private store: StoreLike<any>;
  private readonly setSetting: SetSetting;
  private readonly onModelStatusChanged?: (event: ModelStatusChangedEvent) => void;
  private readonly onModelBatchStatusChanged?: (event: ModelBatchStatusChangedEvent) => void;
  ...
  constructor(options: ModelStatusHelperOptions) {
    ...
    this.onModelStatusChanged = options.onModelStatusChanged;
    this.onModelBatchStatusChanged = options.onModelBatchStatusChanged;
  }
  ...
  setModelStatus(providerId: string, modelId: string, enabled: boolean): void {
    ...
    this.onModelStatusChanged?.({ providerId, modelId, enabled });
  }
  ...
  batchSetModelStatusQuiet(providerId: string, modelStatusMap: Record<string, boolean>): void {
    ...
    this.onModelBatchStatusChanged?.({ providerId, updates });
  }
