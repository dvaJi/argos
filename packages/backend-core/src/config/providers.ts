...
export const DEFAULT_PROVIDERS: LLM_PROVIDER_BASE[] = [
...

  {
    ...
    enable: false,
    websites: {
      official: "https://jiekou.ai?utm_source=github_argos",
      apiKey: "https://jiekou.ai/settings/key-management?utm_source=github_argos",
      docs: "https://docs.jiekou.ai/docs/support/quickstart?utm_source=github_argos",
      models: "https://jiekou.ai/?utm_source=github_argos",
  ...
  // },
  {
    ...
    websites: {
      ...
      defaultBaseUrl: "https://your-resource-name.openai.azure.com/openai/deployments/your-deployment-name",
    },
  },
  {
    id: "modelscope",
