...
// Artifacts-related constant definitions
...
${ARTIFACT_INSTRUCTIONS_HEAD}
    - HTML: "text/html"
      ...
      - do not forget to add AI information in the footer: "Generated with [Argos](https://github.com/dvaJi/argos) | All page content is AI-generated and for reference only" ,ensure it matches the page language
${ARTIFACT_INSTRUCTIONS_TAIL}
<example>
...
<body>
    ...
    <footer>
      Generated with <a href="https://github.com/dvaJi/argos">Argos</a> | All page content is AI-generated and for reference only
    </footer>
</body>
</html>
    </antArtifact>
...
// Schema definitions
const GetArtifactInstructionsArgsSchema = zod.object({
  type: zod.enum(["code", "documents", "html", "svg", "mermaid", "react"]),
});
...
export class ArtifactsServer {
  ...
  constructor() {
    ...
    this.server = new Server(
      {
        name: "argos-inmemory/artifacts-server",
        version: "1.0.0",
      },
      {
        capabilities: {
        ...
        tools: [
          {
            ...
            inputSchema: zod.toJSONSchema(GetArtifactInstructionsArgsSchema, { unrepresentable: "any" }),
            annotations: {
    ...
    this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
      try {
        ...
        if (name === "get_artifact_instructions") {
          ...
          // Combine and return all necessary information
          return {
            content: [
              {
                type: "text",
