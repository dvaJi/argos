...
// Schema definitions
const BraveWebSearchArgsSchema = zod.object({
  query: zod.string().describe("Search query (max 400 chars, 50 words)"),
  count: zod.number().optional().default(10).describe("Number of results (1-20, default 10)"),
  offset: zod.number().optional().default(0).describe("Pagination offset (max 9, default 0)"),
});

const BraveLocalSearchArgsSchema = zod.object({
  query: zod.string().describe("Local search query (e.g. 'pizza near Central Park')"),
  count: zod.number().optional().default(5).describe("Number of results (1-20, default 5)"),
});
        ...
        tools: [
          {
            ...
            inputSchema: zod.toJSONSchema(BraveWebSearchArgsSchema, { unrepresentable: "any" }),
            annotations: {
          ...
          },
          {
            ...
            inputSchema: zod.toJSONSchema(BraveLocalSearchArgsSchema, { unrepresentable: "any" }),
            annotations: {
