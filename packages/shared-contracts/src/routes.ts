...
export const ARGOS_ROUTE_CATALOG = {
  ...
  [workspaceGitListBranchesRoute.name]: workspaceGitListBranchesRoute,
  [workspaceGitListWorktreesRoute.name]: workspaceGitListWorktreesRoute,
  [workspaceGitCreateWorktreeRoute.name]: workspaceGitCreateWorktreeRoute,
  [workspaceGitRemoveWorktreeRoute.name]: workspaceGitRemoveWorktreeRoute,
  ...
  [configGetAgentTypeRoute.name]: configGetAgentTypeRoute,
  ...
  [providersStartAcpAuthRoute.name]: providersStartAcpAuthRoute,
  [providersWriteAcpAuthInputRoute.name]: providersWriteAcpAuthInputRoute,
  [providersCancelAcpAuthRoute.name]: providersCancelAcpAuthRoute,
