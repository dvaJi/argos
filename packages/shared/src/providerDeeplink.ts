...
const SUPPORTED_PROVIDER_INSTALL_CUSTOM_TYPE_SET = new Set<string>(SUPPORTED_PROVIDER_INSTALL_CUSTOM_TYPES);

export type SupportedProviderInstallCustomType = (typeof SUPPORTED_PROVIDER_INSTALL_CUSTOM_TYPES)[number];
...
export type ProviderInstallDeeplinkPayload = ProviderInstallByIdPayload | ProviderInstallByTypePayload;
