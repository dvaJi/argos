...
export type SessionStatus = "idle" | "generating" | "paused" | "waiting_permission" | "waiting_question" | "error";
...
export interface ISessionPresenter extends IThreadPresenter {
  ...
  findWebContentsForSession(sessionId: string, preferredWindowType?: "main" | "floating"): Promise<number | null>;
  ...
  updateNowledgeMemConfig(config: { baseUrl?: string; apiKey?: string; timeout?: number }): Promise<void>;
