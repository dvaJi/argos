...
export const createStreamEvent = {
  ...
  reasoning: (reasoning_content: string, provider_options?: ChatMessageProviderOptions): ReasoningStreamEvent => ({
    type: "reasoning",
    reasoning_content,
    ...(provider_options ? { provider_options } : {}),
  }),
...
export const isToolCallStartEvent = (e: LLMCoreStreamEvent): e is ToolCallStartEvent => e.type === "tool_call_start";
