...
const hasOwnOption = <Key extends string>(value: object, key: Key): value is object & Record<Key, unknown> =>
...
export const summarizeAgentToolContent = (
  ...
  const text =
    typeof content === "string" ? content : content === undefined || content === null ? "" : JSON.stringify(content);
