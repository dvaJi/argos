            ...
            <div className="p-1">
              {provider.models.map((model) => (
                <button
                  ...
                  className={`flex w-full flex-row items-center gap-1 rounded-md p-2 text-left hover:bg-muted dark:hover:bg-accent${isSelected(provider.id, model.id) ? " bg-muted" : ""}`}
