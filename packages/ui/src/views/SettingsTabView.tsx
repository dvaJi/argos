...
export function SettingsTabView() {
  ...
  const [settings, setSettings] = useState<{ title: string; name: string; icon: string; path: string }[]>([]);
  ...
  return (
    <div data-testid="settings-page" className="w-full h-full flex flex-row bg-card mx-auto xl:max-w-6xl">
