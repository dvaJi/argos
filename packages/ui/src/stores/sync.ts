...
import type { SyncBackupInfo, CloudSyncConfigView, CloudSyncConfigInput } from "@argos/shared/presenter";
...
export const importData = async (backupFile: string, mode: "increment" | "overwrite" = "increment") => {
