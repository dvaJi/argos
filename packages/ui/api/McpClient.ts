...
export function createMcpClient(bridge: ArgosBridge = getArgosBridge()) {
  ...
  function onConfigChanged(
    listener: (payload: { mcpServers: Record<string, MCPServerConfig>; mcpEnabled: boolean; version: number }) => void,
  ) {
  ...
  function onSamplingCancelled(listener: (payload: { requestId: string; reason?: string; version: number }) => void) {
