...
import type { IModelConfig, ModelConfig, RENDERER_MODEL_META } from "@argos/shared/presenter";
import { getArgosBridge } from "./core";

export function createModelClient(bridge: ArgosBridge = getArgosBridge()) {
