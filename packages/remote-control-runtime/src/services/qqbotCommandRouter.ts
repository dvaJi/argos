...
export class QQBotCommandRouter {
  ...
  private formatStartMessage(chatType: QQBotInboundMessage["chatType"], auth: QQBotAuthResult): string {
    if (auth.ok) {
      return [
        "Argos QQBot Remote is ready.",
