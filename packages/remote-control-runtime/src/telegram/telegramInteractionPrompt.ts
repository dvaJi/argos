import type { RemotePendingInteraction, TelegramInlineKeyboardButton, TelegramInlineKeyboardMarkup } from "../types";
import {
...
const chunkButtons = (buttons: TelegramInlineKeyboardButton[], rowSize: number): TelegramInlineKeyboardButton[][] => {
