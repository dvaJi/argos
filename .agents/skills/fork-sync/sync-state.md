...
|---|---|---|---|
| `b5a26d85` | #1793 | Stop MCP servers on quit (plugin/mcp shutdown) | PR #2 |
| `3ea97717` | #1786 | Harden chat steer-abort queue | pending |
| `f171c4ff` | #1792 | Remove device-code login | pending |
| `351af841` | #1788 | OpenAI Codex runtime provider | pending |
| `9cb9b581` | #1789 | API-key providers | pending |
| `ce6796e8` | #1776 | CUA cross-platform runtimes | pending |
| `7154ad25` `06a32615` `c7d7e072` `ceefc95e` | — | Tape subsystem (manifest integrity, lineage, facts, view hash) | pending (batch) |
