...
| `72fe36bc` `ce4488aa` `71767ce1` `58978b00` `7082f339` `4344cedf` `bc3b4b08` `4099fdb0` `48b6b035` `7f6f2d92` `c9b205af` `b46c1911` `454417e2` `6e8301b8` | — | Memory subsystem (retrieval, extraction, injection, vector store, persona, lifecycle, settings) | pending (large — unblocked now that tape is done; needs an SDD spec; split into core/retrieval/lifecycle + React UI) |
