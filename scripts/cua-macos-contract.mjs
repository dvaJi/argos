export const CUA_DARWIN_HELPER_APP_NAME = 'Argos Computer Use.app'
export const CUA_DARWIN_HELPER_EXECUTABLE_NAME = 'argos-cua-driver'
export const CUA_DARWIN_HELPER_BUNDLE_IDENTIFIER = 'com.wefonk.argos.computeruse'
