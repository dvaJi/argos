// bun-file-io-exception: sync profile-manager API (validateManagedSkills, writeManagedSkill,
// …) with a deeply sync-chained internal call graph (ensureProfile → writeSettings → …).
