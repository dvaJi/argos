declare module "vue-i18n" {
  interface DefineLocaleMessage {
    ...
    inmemory: {
      ...
      "argos-inmemory/custom-prompts-server": {
        name: string;
        desc: string;
      };
    ...
    dashboard: {
      ...
      summary: {
        ...
        withArgosDaysLabel: string;
        withArgosDaysValue: string;
        withArgosDaysSentence: string;
        withArgosDaysDescription: string;
        withArgosDaysDescriptionUnavailable: string;
        tokenUsage: string;
