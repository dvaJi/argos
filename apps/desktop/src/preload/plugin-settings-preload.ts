...
const argosPluginApi = Object.freeze({
  getPluginId(): string {
    return readPluginId();
  },
...
if (process.contextIsolated) {
  contextBridge.exposeInMainWorld("argosPlugin", argosPluginApi);
} else {
  (window as Window & typeof globalThis & { argosPlugin: typeof argosPluginApi }).argosPlugin = argosPluginApi;
}
