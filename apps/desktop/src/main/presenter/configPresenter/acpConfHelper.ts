...
export class AcpConfHelper {
  ...
  constructor(options?: { mcpConfHelper?: McpConfHelper; storeFactory?: StoreFactory }) {
    this.mcpConfHelper = options?.mcpConfHelper ?? new McpConfHelper(options?.storeFactory);
