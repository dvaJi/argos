...
export function createGitHubCopilotOAuth(clientIdOverride?: string): GitHubCopilotOAuth {
  ...
  console.log(
    ...
    process.env.VITE_GITHUB_CLIENT_SECRET ? "EXISTS" : "NOT SET",
  );
  console.log("  - process.env.VITE_GITHUB_REDIRECT_URI:", process.env.VITE_GITHUB_REDIRECT_URI ? "EXISTS" : "NOT SET");
