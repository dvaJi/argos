...
import type { ExternalToolConfig, ExternalSkillInfo, ScanResult, FormatCapabilities } from "@argos/shared/types/skillSync";
...
export class ToolScanner {
   ...
   */
  private async scanDirectory(skillsDir: string, tool: ExternalToolConfig): Promise<ExternalSkillInfo[]> {
   ...
   */
  private async scanSubdirectories(skillsDir: string, tool: ExternalToolConfig): Promise<ExternalSkillInfo[]> {
    const skills: ExternalSkillInfo[] = [];
   ...
   */
  private async scanFiles(skillsDir: string, tool: ExternalToolConfig): Promise<ExternalSkillInfo[]> {
    const skills: ExternalSkillInfo[] = [];
