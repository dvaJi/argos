...
export class TabManager {
  ...
  async bindToTab(sessionId: string, tabId: number, windowType: "main" | "floating" | "browser"): Promise<void> {
  ...
  async activateSession(tabId: number, sessionId: string): Promise<void> {
    ...
    if (existingTabId && existingTabId !== tabId) {
      ...
      if (existingMetadata && targetMetadata && existingMetadata.windowType === targetMetadata.windowType) {
