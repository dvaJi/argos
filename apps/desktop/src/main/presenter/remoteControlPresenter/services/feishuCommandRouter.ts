...
export class FeishuCommandRouter {
  ...
  private buildPendingPromptResult(interaction: RemotePendingInteraction): FeishuCommandRouteResult {
    return {
      replies: [],
      outboundActions: [
        {
