...
export const conversationExportTemplates: ExportTemplates = {
  ...
  templates: {
    ...
    metaRow: '        <div class="meta-row"><span class="meta-label">{{label}}</span><span>{{value}}</span></div>',
    userMessage: [
      '    <article class="message user-message">',
      '      <header class="message-header">',
      '        <div class="message-avatar">👤</div>',
      "        <div>",
      '          <div class="message-identity">User</div>',
    ...
    assistantMessage: [
      ...
      '        <div class="message-avatar">🤖</div>',
      "        <div>",
      '          <div class="message-identity">Assistant</div>',
      '          <div class="message-meta">{{timestamp}}</div>',
      "        </div>",
      "      </header>",
      "{{assistantBlocks}}",
    ...
    linkItem: '          <li><a href="{{href}}" target="_blank" rel="noopener noreferrer">{{label}}</a></li>',
    ...
    assistantArtifact: [
      '      <div class="section reasoning-block">',
      '        <div class="section-title">Creative thinking</div>',
      '        <pre class="code">{{content}}</pre>',
      "      </div>",
    ],
    assistantToolCall: [
    ...
    assistantSearchCaption: '        <div class="section-caption">Found {{total}} search results</div>',
    assistantImage: [
      '      <div class="section">',
      '        <div class="section-title">Image</div>',
      '        <div class="message-content">*[image content]*</div>',
      "      </div>",
    ],
    assistantError: ['      <div class="section error-block">', "        ❌ {{content}}", "      </div>"],
