...
const createDefinition = (definition: AiSdkProviderDefinition): AiSdkProviderDefinition => definition;
...
export function resolveAiSdkProviderDefinition(provider: LLM_PROVIDER): AiSdkProviderDefinition | null {
