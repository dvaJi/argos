...
import { AcpRegistryMigrationService } from "@argos/acp-runtime";
...
export const acpRegistryMigrationHook: LifecycleHook = {
  ...
  execute: async (_context: LifecycleContext) => {
    ...
    const service = new AcpRegistryMigrationService(presenter.configPresenter, presenter.sqlitePresenter);
