...
Object.assign(contextMenuTranslations, {
  "es-ES": {
    ...
    showHide: "Mostrar/ocultar Argos",
  },
  "de-DE": {
    copy: "Kopieren",
    paste: "Einfügen",
  ...
  "id-ID": {
    ...
    showHide: "Tampilkan/sembunyikan Argos",
  },
  "ms-MY": {
    copy: "Salin",
    paste: "Tampal",
    ...
    showHide: "Tunjuk/sembunyikan Argos",
  },
  "it-IT": {
    copy: "Copia",
    paste: "Incolla",
    ...
    showHide: "Mostra/nascondi Argos",
  },
  "pl-PL": {
    copy: "Kopiuj",
    paste: "Wklej",
...
export const errorMessageTranslations: Record<string, TranslationMap> = {
  ...
  "en-US": {
    ...
    needAtLeastOneRagflowConfig: "Need to provide at least one RAGFlow knowledge base configuration",
  ...
  ja: {
    ...
    addMcpServerDuplicateMessage: "サーバー名「{serverName}」はすでに存在します。別の名前を選択してください。",
    getMcpToolListErrorTitle: "ツール定義の取得に失敗しました",
    getMcpToolListErrorMessage: "サーバー '{serverName}' からツールリストを取得できません: {errorMessage}",
  ...
  ko: {
    ...
    addMcpServerDuplicateMessage: '서버 이름 "{serverName}"이(가) 이미 존재합니다. 다른 이름을 선택하십시오.',
    getMcpToolListErrorTitle: "도구 정의 가져오기 실패",
    getMcpToolListErrorMessage: "서버 '{serverName}'에서 도구 목록을 검색할 수 없습니다: {errorMessage}",
  ...
  fr: {
    ...
    addMcpServerDuplicateMessage: 'Le nom du serveur "{serverName}" existe déjà. Veuillez choisir un nom différent.',
    getMcpToolListErrorTitle: "Échec de la récupération des définitions d'outils",
    getMcpToolListErrorMessage: "Impossible de récupérer la liste d'outils du serveur '{serverName}': {errorMessage}",
    ...
    needAtLeastOneRagflowConfig: "Vous devez fournir au moins une configuration de base de connaissances RAGFlow",
    needAtLeastOneDifyConfig: "Vous devez fournir au moins une configuration de base de connaissances Dify",
  ...
  de: {
    ...
    addMcpServerDuplicateMessage: 'Servername "{serverName}" existiert bereits. Bitte wählen Sie einen anderen Namen.',
    getMcpToolListErrorTitle: "Tooldefinitionen konnten nicht abgerufen werden",
    getMcpToolListErrorMessage: "Die Toolliste konnte nicht vom Server '{serverName}' abgerufen werden: {errorMessage}",
    ...
    needAtLeastOneRagflowConfig: "Es muss mindestens eine RAGFlow-Konfiguration bereitgestellt werden",
  ...
  es: {
    ...
    needRagflowDatasetIds: "Se debe proporcionar al menos un identificador de conjunto de datos de RAGFlow",
  ...
  "pt-BR": {
    ...
    addMcpServerDuplicateMessage: 'O nome do servidor "{serverName}" já existe. Por favor, escolha um nome diferente.',
    ...
    needAtLeastOneRagflowConfig: "É necessário fornecer pelo menos uma configuração da base de conhecimento RAGFlow",
    needAtLeastOneDifyConfig: "É necessário fornecer pelo menos uma configuração da base de conhecimento Dify",
...
Object.assign(errorMessageTranslations, {
  "es-ES": {
    ...
    addMcpServerDuplicateMessage: 'El nombre de servidor "{serverName}" ya existe. Elige otro nombre.',
    ...
    needAtLeastOneRagflowConfig: "Debes proporcionar al menos una configuración de base de conocimiento RAGFlow",
    needAtLeastOneDifyConfig: "Debes proporcionar al menos una configuración de base de conocimiento Dify",
  ...
  "de-DE": {
    ...
    getMcpToolListErrorTitle: "Tooldefinitionen konnten nicht abgerufen werden",
    getMcpToolListErrorMessage: "Die Toolliste konnte vom Server '{serverName}' nicht abgerufen werden: {errorMessage}",
    genericErrorTitle: "Fehler",
    ...
    needAtLeastOneRagflowConfig: "Mindestens eine Konfiguration der RAGFlow-Wissensdatenbank muss angegeben werden",
    needAtLeastOneDifyConfig: "Mindestens eine Konfiguration der Dify-Wissensdatenbank muss angegeben werden",
  ...
  "tr-TR": {
    ...
    addMcpServerDuplicateMessage: '"{serverName}" sunucu adı zaten var. Lütfen farklı bir ad seçin.',
    getMcpToolListErrorTitle: "Araç tanımları alınamadı",
    getMcpToolListErrorMessage: "'{serverName}' sunucusundan araç listesi alınamadı: {errorMessage}",
  ...
  "id-ID": {
    ...
    getMcpToolListErrorMessage: "Tidak dapat mengambil daftar alat dari server '{serverName}': {errorMessage}",
    ...
    needAtLeastOneRagflowConfig: "Setidaknya satu konfigurasi basis pengetahuan RAGFlow perlu disediakan",
  ...
  "ms-MY": {
    ...
    getMcpToolListErrorTitle: "Gagal mendapatkan definisi alat",
    getMcpToolListErrorMessage: "Tidak dapat mendapatkan senarai alat daripada pelayan '{serverName}': {errorMessage}",
    ...
    needAtLeastOneRagflowConfig: "Sekurang-kurangnya satu konfigurasi pangkalan pengetahuan RAGFlow perlu diberikan",
    needAtLeastOneDifyConfig: "Sekurang-kurangnya satu konfigurasi pangkalan pengetahuan Dify perlu diberikan",
  ...
  "it-IT": {
    ...
    needAtLeastOneRagflowConfig: "Devi fornire almeno una configurazione della base di conoscenza RAGFlow",
    needAtLeastOneDifyConfig: "Devi fornire almeno una configurazione della base di conoscenza Dify",
  ...
  "pl-PL": {
    ...
    getMcpToolListErrorMessage: "Nie można pobrać listy narzędzi z serwera '{serverName}': {errorMessage}",
    ...
    needKnowledgeBaseDescription: "Wymagany jest opis tej bazy wiedzy, aby AI mogła zdecydować, czy ją pobrać",
  },
  "vi-VN": {
    ...
    getMcpToolListErrorMessage: "Không thể lấy danh sách công cụ từ máy chủ '{serverName}': {errorMessage}",
...
export function getBestMatchTranslation(locale: string, translations: Record<string, TranslationMap>): TranslationMap {
  ...
  for (const supported of supportedLocales) {
    if (locale.startsWith(supported) || (supported.includes("-") && locale.startsWith(supported.split("-")[0]))) {
