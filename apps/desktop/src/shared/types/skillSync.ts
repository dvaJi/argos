 ...
 *
 * This module defines types for synchronizing skills between Argos
...
export interface NewDiscovery {
  ...
  /** Tool display name */
  toolName: string;
  /** Newly discovered skills (not in cache and not in Argos) */
...
export interface ISkillSyncPresenter {
  ...
  /**
   * Get new discoveries (skills not in cache and not in Argos)
   */
