...
describe("AI SDK stream adapter", () => {
  it("maps native tool streaming events to Argos core events", async () => {
      ...
      [
        {
          type: "text-delta",
          id: "text-1",
          text: 'before <function_call>{"function_call":{"name":"search","arguments":{"q":"argos"}}}</function_call> after',
        },
        {
          type: "finish",
          finishReason: "stop",
