...
describe("FileValidationService", () => {
  ...
  describe("adapter filtering logic", () => {
    it("should correctly identify excluded adapters", () => {
      const excludedAdapters = ["AudioFileAdapter", "ImageFileAdapter", "UnsupportFileAdapter", "DirectoryAdapter"];
  ...
  describe("integration with existing adapter system", () => {
    it("should work with the actual adapter map structure", async () => {
      ...
      // Import and use the real function directly (bypasses the module mock)
      const { getMimeTypeAdapterMap: realGetMimeTypeAdapterMap } =
        await vi.importActual<typeof import("@argos/file-adapters/mime")>("@argos/file-adapters/mime");
