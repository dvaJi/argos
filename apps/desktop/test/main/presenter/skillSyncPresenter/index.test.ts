...
vi.mock("../../../../src/main/presenter/skillSyncPresenter/toolScanner", () => ({
  ...
  resolveSkillsDir: vi.fn((tool, projectRoot) => {
    ...
    return tool.isProjectLevel ? path.join(projectRoot, tool.skillsDir) : `/home/user/${tool.skillsDir}`;
  }),
}));
...
describe("SkillSyncPresenter", () => {
  ...
  beforeEach(() => {
    ...
    scanWorkerMock.scanAndDetectDiscoveriesInWorker.mockRejectedValue(new Error("worker unavailable"));
