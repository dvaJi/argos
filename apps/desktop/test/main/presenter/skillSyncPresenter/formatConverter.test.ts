...
import { FormatConverter, ConversionWarning } from "../../../../src/main/presenter/skillSyncPresenter/formatConverter";
import type { CanonicalSkill } from "@argos/shared/types/skillSync";
...
Review the code and provide feedback.`;
    ...
    it("should throw error for unknown tool", async () => {
      ...
      await expect(converter.parseExternal("content", context)).rejects.toThrow("No adapter found for tool");
    });
  });
  ...
  describe("serializeToExternal", () => {
    ...
    it("should throw error for unknown tool", () => {
      ...
      expect(() => converter.serializeToExternal(skill, "unknown-tool")).toThrow("No adapter found for tool");
    });
  });

  describe("serializeToSkillMd", () => {
    it("should serialize to Argos SKILL.md format", () => {
      const skill: CanonicalSkill = {
        name: "my-skill",
        description: "A test skill",
        instructions: "Do something useful.",
