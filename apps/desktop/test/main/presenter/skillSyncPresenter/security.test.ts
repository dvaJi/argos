...
describe("Security Module", () => {
  ...
  describe("validateImportOperation", () => {
    ...
    it("should return invalid for unknown tool ID", async () => {
      const result = await validateImportOperation("/base/skill.md", "unknown-tool", "my-skill", "/base");
    ...
    it("should return invalid for bad skill name", async () => {
      const result = await validateImportOperation("/base/skill.md", "claude-code", "../bad-name", "/base");
  ...
  describe("validateExportOperation", () => {
    ...
    it("should return invalid for path outside base", async () => {
      ...
      const result = await validateExportOperation("/other/path/skill.md", "cursor", "my-skill", "/base");
