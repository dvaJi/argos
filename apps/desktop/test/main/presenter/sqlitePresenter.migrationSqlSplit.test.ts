...
CREATE INDEX sample_value_idx ON sample(value);`
    ...
    presenter.argosSessionsTable = emptyTable;
    presenter.argosMessagesTable = emptyTable;
    presenter.argosUserMessagesTable = emptyTable;
    presenter.argosUserMessageFilesTable = emptyTable;
    presenter.argosUserMessageLinksTable = emptyTable;
    presenter.argosAssistantBlocksTable = emptyTable;
    presenter.argosMessageTracesTable = emptyTable;
    presenter.argosMessageSearchResultsTable = emptyTable;
    presenter.argosSearchDocumentsTable = emptyTable;
    presenter.argosPendingInputsTable = emptyTable;
    presenter.argosUsageStatsTable = emptyTable;
    presenter.argosTapeEntriesTable = emptyTable;
