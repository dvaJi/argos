...
import type { QQBotRuntimeStatusSnapshot } from "@argos/remote-control-runtime/types";
...
vi.mock("@argos/remote-control-runtime/qqbot/qqbotRuntime", () => ({
...
vi.mock("@argos/remote-control-runtime/qqbot/qqbotClient", () => ({
...
import { QQBotAdapter } from "@argos/remote-control-runtime/adapters/qqbot/QQBotAdapter";
