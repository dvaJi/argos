...
import type { DiscordRuntimeStatusSnapshot } from "@argos/remote-control-runtime/types";
...
vi.mock("@argos/remote-control-runtime/discord/discordRuntime", () => ({
...
vi.mock("@argos/remote-control-runtime/discord/discordClient", () => ({
...
import { DiscordAdapter } from "@argos/remote-control-runtime/adapters/discord/DiscordAdapter";
...
describe("DiscordAdapter", () => {
  ...
  it("rejects malformed discord transport targets instead of truncating them", async () => {
    ...
    await expect(adapter.sendTypingIndicator("dm:")).rejects.toThrow('Invalid Discord transport target "dm:".');
  });
});
