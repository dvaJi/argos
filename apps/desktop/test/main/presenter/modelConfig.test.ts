...
import { DEFAULT_MODEL_TIMEOUT } from "@argos/shared/modelConfigDefaults";
import { ModelConfig } from "@argos/shared/presenter";
...
describe("Model Configuration Tests", () => {
  ...
  describe("Metadata synchronization and provider-managed configs", () => {
    ...
    it("keeps user configs but drops provider configs when defaults change", () => {
      ...
      const refreshedProviderConfig = refreshedHelper.getModelConfig(providerManagedModelId, providerId);
