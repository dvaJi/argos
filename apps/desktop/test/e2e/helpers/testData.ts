export const E2E_TARGET_PROVIDER_ID = process.env.ARGOS_E2E_PROVIDER_ID ?? "minimax";
export const E2E_TARGET_MODEL_ID = process.env.ARGOS_E2E_MODEL_ID ?? "MiniMax-M2.7";
