...
const settingsPages = [
  ...
  {
    name: "argos-agents",
    tabTestId: "settings-tab-argos-agents",
    pageTestId: "settings-argos-agents-page",
  },
  {
    name: "acp",
...
async function applyVisualState(page: Page, options: { dark?: boolean; rtl?: boolean }): Promise<void> {
