...
describe("DashboardSettings", () => {
  ...
  it("renders summary cards and breakdown rows when stats exist", async () => {
    ...
    expect(container.textContent).toContain("You and Argos have spent 17 days together.");
    ...
    expect(container.textContent).toContain("Mar 9, 2026 was your most active day, with 2 messages.");
    ...
    expect(screen.getByTestId("token-usage-input-dot").getAttribute("style")).toContain("var(--primary-600)");
    ...
    expect(screen.getByTestId("token-usage-cost-row").textContent).toContain("Trend over the last 30 days");
