...
export const normalizeDeepChatSubagentSlots = (slots?: DeepChatSubagentSlot[] | null): DeepChatSubagentSlot[] => {
...
export const normalizeDeepChatSubagentConfig = (config?: DeepChatAgentConfig | null): DeepChatAgentConfig => {
