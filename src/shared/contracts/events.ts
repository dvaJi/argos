...
export type DeepchatEventPayload<T extends DeepchatEventName> = z.output<DeepchatEventContract<T>["payload"]>;
...
export function getDeepchatEventContract<T extends DeepchatEventName>(name: T): DeepchatEventContract<T> {
