...
const VIDEO_GENERATION_MODEL_ID_MARKERS = ["seedance", "-t2v", "-i2v", "-r2v", "videoedit", "video-edit"] as const;
...
export function resolveVideoGenerationCompatType(target: VideoGenerationDetectionTarget): ModelType | undefined {
...
export function supportsOpenAICompatibleVideoGeneration(target: VideoGenerationDetectionTarget): boolean {
  ...
  return isOpenAICompatibleProvider && resolveVideoGenerationCompatType(target) === ModelType.VideoGeneration;
}
