...
const CATALOG_DEFINITIONS: CatalogDefinition[] = [
  ...
  },
  {
    ...
    repairableColumns: {
      ...
      image_generation_options_json: "ALTER TABLE deepchat_sessions ADD COLUMN image_generation_options_json TEXT;",
      video_generation_options_json: "ALTER TABLE deepchat_sessions ADD COLUMN video_generation_options_json TEXT;",
    },
