...
export class SubagentOrchestratorTool {
  ...
  async call(
    ...
    if (parent.agentType !== "deepchat" || parent.sessionKind !== "regular" || parent.subagentEnabled !== true) {
      throw new Error("subagent_orchestrator is only available in DeepChat regular sessions with subagents enabled.");
    }
