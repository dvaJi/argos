...
export function convertDeepChatToNowledgeMemFormat(conversation: CONVERSATION, messages: Message[]): NowledgeMemThread {
  ...
  return {
    ...
    metadata: {
      conversation: {
        ...
        tags: ["deepchat-export", conversation.settings.providerId, conversation.settings.modelId].filter(
          Boolean,
        ) as string[],
        settings: {
