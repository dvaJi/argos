...
const isPermissionType = (value: unknown): value is RemotePendingInteractionPermission["permissionType"] =>
...
export const parsePermissionPayload = (
    ...
    try {
      ...
      if (parsed && typeof parsed === "object" && !Array.isArray(parsed)) {
        ...
        return {
          ...
          ...(typeof parsed.command === "string" && parsed.command.trim() ? { command: parsed.command } : {}),
  ...
  return {
    ...
    ...(typeof block.extra?.providerId === "string" && block.extra.providerId.trim()
      ...
      : {}),
    ...(typeof block.extra?.permissionRequestId === "string" && block.extra.permissionRequestId.trim()
...
export const collectPendingInteraction = (
  ...
  for (const block of blocks) {
    ...
    const base = {
      ...
      ...(block.tool_call?.server_description ? { serverDescription: block.tool_call.server_description } : {}),
    };
    ...
    if (block.action_type === "question_request") {
      return {
        ...
        question: {
          ...
          question: typeof block.extra?.questionText === "string" ? block.extra.questionText : block.content || "",
