...
export const buildFeishuPendingInteractionText = (interaction: RemotePendingInteraction): string => {
  ...
  return {
    ...
    elements: [
      ...
      ...(interaction.type === "question"
        ? [
            ...(question?.header?.trim() ? [createMarkdownBlock(`**${question.header.trim()}**`)] : []),
