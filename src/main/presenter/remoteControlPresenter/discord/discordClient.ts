...
export class DiscordClient {
  ...
  async registerCommands(applicationId: string, commands: DiscordSlashCommandDefinition[]): Promise<void> {
  ...
  async sendImage(channelId: string, filePath: string, content: string = ""): Promise<string | null> {
  ...
  private async request(path: string, init: RequestInit, auth: "bot" | "none" = "bot"): Promise<Response> {
