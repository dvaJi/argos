...
export class PluginPresenter {
  ...
  private arePluginManifestsEquivalent(left: DeepChatPluginManifest, right: DeepChatPluginManifest): boolean {
  ...
  private applyDeclaredExecutablePermissions(manifest: DeepChatPluginManifest, pluginRoot: string): void {
