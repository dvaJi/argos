...
function summaryStateFromTapeAnchor(row: DeepChatTapeEntryRow | undefined): SessionSummaryState | null {
  if (!row) {
    return null;
  }
...
export class DeepChatSessionStore {
  ...
  create(
    ...
    this.sqlitePresenter.deepchatSessionsTable.create(id, providerId, modelId, permissionMode, generationSettings);
