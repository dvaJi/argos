...
import type { FloatingWidgetSessionItem as SessionItem } from '@shared/types/floating-widget'
...
const STATUS_CLASSES: Record<string, string> = {
  in_progress:
    'border-slate-200 bg-slate-100 text-slate-700 dark:border-white/10 dark:bg-[#1a232b] dark:text-white/72',
  error:
    'border-rose-200 bg-rose-50 text-rose-700 dark:border-rose-400/18 dark:bg-[#27161b] dark:text-rose-100',
...
const ACCENT_CLASSES: Record<string, string> = {
  in_progress:
    'bg-slate-400/80 shadow-[0_0_16px_rgba(148,163,184,0.22)] dark:bg-white/24 dark:shadow-none',
  error:
...
const DOT_CLASSES: Record<string, string> = {
  in_progress:
    'bg-slate-500 shadow-[0_0_10px_rgba(100,116,139,0.28)] animate-pulse dark:bg-white/55 dark:shadow-none',
...
export default function FloatingSessionItem({
  session,
  theme,
  onSelect
}: FloatingSessionItemProps) {
  const statusKey =
