...
export function HTMLArtifact({ block, isPreview, viewportSize = "desktop", className }: HTMLArtifactProps) {
  ...
  const frameContainerClasses = resolvedViewportSize === "desktop" ? "h-full min-h-0 w-full" : "relative shrink-0";
