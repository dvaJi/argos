...
export const MessageContent: React.FC<MessageContentProps> = ({ content, onMentionClick }) => {
  const langStore = useStore(useLanguageStore)

  const contentBlocks = useMemo(() => content || [], [content])

  return (
    <div className="text-sm whitespace-pre-wrap break-all" dir={langStore.dir}>
