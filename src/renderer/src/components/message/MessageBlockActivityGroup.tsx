...
export const MessageBlockActivityGroup: React.FC<MessageBlockActivityGroupProps> = ({
  blocks,
  messageId,
  threadId,
  usage,
  ...
  const durationText = useMemo(
    () => formatActivityDuration(durationMs, durationLabels),
    [durationMs, durationLabels]
  )
  ...
  return (
    <div className="flex flex-col w-full" data-testid="activity-group">
      ...
      >
        <div
          className="min-h-0 flex flex-col w-full gap-1.5 overflow-hidden"
            ...
            if (
              ...
              return (
                <MessageBlockThink
                  ...
                  block={block}
                  usage={usage}
                  onToggleCollapse={handleChildCollapseToggle}
                />
              )
            }
