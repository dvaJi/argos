...
export const MessageBlockError: React.FC<MessageBlockErrorProps> = ({ block }) => {
  ...
  return (
    <div className="cursor-default select-none">
      <div
        className="text-xs text-red-500 flex flex-row items-center group"
      ...
      {errorExplanation && (
        <div className="mt-2 text-red-400 font-medium">Cause of error: {errorExplanation}</div>
      )}
    </div>
  )
}
