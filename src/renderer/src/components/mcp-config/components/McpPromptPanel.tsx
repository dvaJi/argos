...
export const McpPromptPanel: React.FC<McpPromptPanelProps> = ({
  serverName,
  open,
  onOpenChange
}) => {
                ...
                <div className="h-full flex flex-col overflow-hidden min-h-0">
                  <ScrollArea className="flex-1 min-h-0">
                    <div className="px-4 py-4 space-y-4 pb-8">
                        ...
                        <div className="border rounded-lg">
                          ...
                          >
                            <span className="font-medium">
                              Parameters ({promptArgsDescription.length})
                            </span>
                            <Icon
                              icon={
                      ...
                      {promptResult && (
                        <McpJsonViewer content={promptResult} title="Result" readonly />
                      )}
                    </div>
                  </ScrollArea>
                </div>
