...
export function isSpeechRecognitionSupported(speechWindow: SpeechRecognitionWindow | undefined): boolean {
  return isMediaRecorderSupported(speechWindow) && resolveAudioContextConstructor(speechWindow) !== null;
}
...
async function convertAudioBlobToWav(blob: Blob, speechWindow: SpeechRecognitionWindow | undefined): Promise<Blob> {
...
export function useSpeechRecognition(options: {
  ...
  transcribe: (payload: SpeechRecognitionAudioPayload, options?: { signal?: AbortSignal }) => Promise<string>;
  onUnsupported?: () => void;
