    ...
    <div className="space-y-4">
      <div className="space-y-2">
        ...
        <p className="text-xs text-muted-foreground">
          Configure text-to-speech settings for this model
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          onChange={(e) => onVoiceInput(e.target.value)}
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Select
          value={optionSelectValue(tts.responseFormat)}
          onValueChange={onResponseFormatSelect}
        >
          <SelectTrigger>
