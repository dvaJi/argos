...
export default function ProviderApiConfig({
  ...
  const isBaseUrlEditableByDefault =
    provider.custom || EDITABLE_BASE_URL_PROVIDER_IDS.has(provider.id)
        ...
        <div className="w-full rounded-md border border-amber-300 bg-amber-50 px-3 py-2 text-amber-900">
          <div className="flex items-start gap-2">
            ...
            <p className="text-sm font-medium leading-5">
              OpenAI Responses API is used by default. You can switch to Chat Completions in the
              model settings.
            </p>
          </div>
        </div>
        ...
        {showLockedBaseUrl ? (
          <div className="flex w-full items-center gap-2">
            ...
            <Button
              ...
              onClick={() => setBaseUrlUnlocked(true)}
            >
              Modify
            </Button>
          </div>
      ...
      {provider.id === 'github-copilot' ? (
        ...
        <div className="flex flex-col items-start gap-4">
          <div className="flex flex-col gap-2 w-full">
            ...
            {keyStatus &&
              (keyStatus.usage !== undefined || keyStatus.limit_remaining !== undefined) && (
