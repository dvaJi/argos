...
import { getSettingsNavigationItems, resolveTitle, resolveSettingsNavigationPath } from "@shared/settingsNavigation";
  ...
  return (
    ...
    >
      ...
      <section className="grid gap-3 md:grid-cols-2 xl:grid-cols-4">
        ...
        />
        <StatusMetricCard
          label={resolveTitle("settings.overview.metrics.deepchatAgents")}
          value={`${enabledDeepChatAgentsCount} ${resolveTitle("settings.overview.metrics.enabled")}`}
          icon="lucide:bot"
          description={resolveTitle("settings.overview.metrics.deepchatAgentsDescription")}
          interactive
