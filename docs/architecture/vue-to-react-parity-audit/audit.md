...
- Original reference: `H:\o-proy\deepchat`
...
- Original DeepChat mounts the full MCP server management UI, add-server flow, advanced npm-registry settings, and onboarding overlay:
  - `H:\o-proy\deepchat\src\renderer\settings\components\McpSettings.vue:37-167`
  - `H:\o-proy\deepchat\src\renderer\settings\components\McpSettings.vue:175-319`

### 2. DeepChat Agents editor is materially reduced

- `argos3` exposes a basic list, enable/delete actions, and editable system prompt only:
  - `src/renderer/settings/components/DeepChatAgentsSettings.tsx:83-216`
- Original DeepChat includes avatar modes/colors, description, multiple model selectors, default project path, permission mode, subagents, tool selection, compaction settings, and prompt template dialog:
  - `H:\o-proy\deepchat\src\renderer\settings\components\DeepChatAgentsSettings.vue:107-337`
  - `H:\o-proy\deepchat\src\renderer\settings\components\DeepChatAgentsSettings.vue:389-586`
  - `H:\o-proy\deepchat\src\renderer\settings\components\DeepChatAgentsSettings.vue:675-1247`
...
- Original DeepChat had R2 vs custom provider mode, guided help, validation/warnings, safe-storage messaging, save-first gating, and separate save-only vs save-and-test flows:
  - `H:\o-proy\deepchat\src\renderer\settings\components\DataSettings.vue:168-484`
  - `H:\o-proy\deepchat\src\renderer\settings\components\DataSettings.vue:1321-1449`
...
- Original DeepChat has a full database-encryption section with status, enable/change/disable actions, password dialog, and migration/safe-storage messaging:
  - `H:\o-proy\deepchat\src\renderer\settings\components\DataSettings.vue:503-673`
  - `H:\o-proy\deepchat\src\renderer\settings\components\DataSettings.vue:1138-1241`
  - `H:\o-proy\deepchat\src\renderer\settings\components\DataSettings.vue:1493-1575`

### 5. Provider ordering and reordering support is missing

- Original DeepChat uses draggable enabled/disabled provider lists:
  - `H:\o-proy\deepchat\src\renderer\settings\components\ModelProviderSettings.vue:65-73`
  - `H:\o-proy\deepchat\src\renderer\settings\components\ModelProviderSettings.vue:128-136`
...
- Original DeepChat uses `t(...)` on the same surfaces:
  - `H:\o-proy\deepchat\src\renderer\src\pages\WelcomePage.vue:27-56`
  - `H:\o-proy\deepchat\src\renderer\src\pages\WelcomePage.vue:73-108`
  - `H:\o-proy\deepchat\src\renderer\src\pages\WelcomePage.vue:123-141`
  - `H:\o-proy\deepchat\src\renderer\src\pages\WelcomePage.vue:224-237`
  - `H:\o-proy\deepchat\src\renderer\settings\components\ModelProviderSettings.vue:33-45`
  - `H:\o-proy\deepchat\src\renderer\settings\components\DataSettings.vue:172-176`
- Recent activity text is also untranslated/raw in `argos3`:
  - `src/renderer/settings/components/SettingsOverview.tsx:293-295`
- Original DeepChat translates the same activity strings with params:
  - `H:\o-proy\deepchat\src\renderer\settings\components\SettingsOverview.vue:132-135`
...
- Original DeepChat does the same:
  - `H:\o-proy\deepchat\src\renderer\src\views\ChatTabView.vue:68-125`
  - `H:\o-proy\deepchat\src\renderer\src\views\ChatTabView.vue:6-21`
...
- But full parity for composer behavior, advanced model controls, attachments/artifacts, and browser-side interactions still needs runtime comparison against:
  - `H:\o-proy\deepchat\src\renderer\src\pages\ChatPage.vue`
  - `H:\o-proy\deepchat\src\renderer\src\pages\NewThreadPage.vue`
