...
Migrate the Argos Electron renderer from Vue 3 to React while preserving all existing app behavior, layout, IPC contracts, and desktop-first architecture.
