...
Compare the migrated React renderer/settings surface in `argos3` against the original Argos Vue implementation and document confirmed user-facing parity gaps.
