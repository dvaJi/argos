...
- "Skill draft generated: xxx"
- Options: View content / Install as Skill / Discard
...
3. Choosing "View content" shows the draft `SKILL.md` content and keeps the draft available for a later install/discard choice.
4. Choosing "Install as Skill" installs the draft into the configured skills directory and resumes the Agent with a clear success/failure tool result.
5. Choosing "Discard" deletes the draft and resumes the Agent with a clear result.
6. Existing `argos_question` interactions continue to work unchanged.
